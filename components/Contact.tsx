  ...
  return (
    <section id="contact" className="relative px-6 py-28 sm:py-44">
      <div className="mx-auto max-w-5xl text-center">
        ...
        <Reveal delay={160}>
          <p className="mx-auto mt-8 max-w-md text-base font-light leading-relaxed text-muted">
        ...
        <Reveal delay={220}>
          <div className="mt-12 flex flex-col items-center gap-6">
            <a
              ...
              className="group relative overflow-hidden rounded-full bg-gold px-10 py-4 text-sm font-medium tracking-wide text-ink transition-colors duration-500"
            >
