...
// href set = links to the real product page (Dream Studio).
// No href = link not received yet, CTA falls back to email.
const ebooks = [
  {
    tag: "Mindset",
    title: "Clarté Mentale",
    href: "https://www.dream-studio.fr/products/guide-pdf-creer-son-setup-podcast",
  },
  { tag: "Méthode", title: "Carte Mentale" },
  {
    tag: "Média",
    title: "Lancer son podcast",
    href: "https://www.dream-studio.fr/products/guide-pdf-monter-son-podcast-simplement",
  },
];

export default function Ebooks() {
  return (
    <section id="ebooks" className="relative px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-3">
          {ebooks.map((e) => {
            const href =
              e.href ??
              `mailto:${CONTACT_EMAIL}?subject=E-book — ${encodeURIComponent(e.title)}`;
            const external = Boolean(e.href);
            return (
